  ...
  $.post("/device_list", _post_data, function (res) {
    ...
    if (res.data.length > 0) {
      ...
      res.data.forEach(function (element, ind) {
        ...
        html +=
          '<div class="col-md-2 bg-dark rounded m-2"><div class="row mt-2"><div class="col-md-2"><span title="หมายเลข ' +
          element.number +
          '" class="' +
          _color +
          '"></span></div><div class="col-md-4">Volume</div><div class="col-md-6">' +
          '<select class="form-control select-set-volume" device_id="' +
          element._id +
          '">' +
          _vol_element +
          '<option value="10">10</option><option value="8">8</option><option value="6">6</option><option value="4">4</option>' +
...
$(function () {
  ...
  // Test for PRD api
  //console.log($.get("/pa_prd_radio_list"));
  $.getJSON("/public/data/station_list_v2.json").done(function (data) {
  ...
  //   data: [
  //     {
  //       id: "https://radio-org-01-ott.prd.go.th/nma_fm105_25",
  //       text: "สวท.นครราชสีมา FM 105.25 MHz",
  //     },
  //     {
  //       id: "https://radio-org-01-ott.prd.go.th/nma_am729",
  //       text: "สวท.นครราชสีมา AM 729 KHz",
  //     },
  //     {
  //       id: "https://radio-org-01-ott.prd.go.th/srn_fm97_5",
  //       text: "สวท.สุรินทร์ FM 97.50 MHz",
  //     },
  //     {
  //       id: "https://radio-org-01-ott.prd.go.th/srn_fm93_5",
  //       text: "สวท.สุรินทร์ FM 93.50 MHz",
  //     },
  //     {
  //       id: "https://radio-org-01-ott.prd.go.th/cmi_fm89_25",
  //       text: "สวท.ฝาง FM 89.25 MHz",
  //     },
  //     {
  //       id: "https://radio-org-01-ott.prd.go.th/lpg_fm97",
  //       text: "สวท.ลำปาง FM 97 MHz",
  //     },
  //     {
  //       id: "https://radio-org-01-ott.prd.go.th/lpg_am549",
  //       text: "สวท.ลำปาง เพื่อการเรียนรู้และเตือนภัยภาคเหนือ AM 549 KHz",
  //     },
  //     {
  //       id: "https://radio-org-01-ott.prd.go.th/ryg_fm91_75",
  //       text: "สวท.ระยอง FM 91.75 MHz",
  //     },
  //     {
  //       id: "https://radio-org-01-ott.prd.go.th/pkt_am1062",
  //       text: "สวท.ภูเก็ต FAM 1062 KHz",
  //     },
  //     {
  //       id: "https://radio-org-01-ott.prd.go.th/yla_fm93",
  //       text: "สวท.เบตง FM 93 MHz",
  //     },
  //   ],
  // });
});
